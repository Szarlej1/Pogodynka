...
/**
 * Created by Marcin B on 2017-04-22.
 */

public class HourAdapter extends RecyclerView.Adapter<HourAdapter.HourViewHolder> {

    private Hour[] mHours;
    private Context mContext; // potrzebne do Tosta, trzeba też umieścić w konstruktorze
    ...
    public class HourViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v) {
            ...
            String message = String.format("O %s będzie %s. Ogólnie to %s",
                    time,
                    temperature,
                    summary);
